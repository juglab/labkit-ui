...
@Plugin(type = Command.class, menuPath = "Plugins>Segmentation>Bayesian Inference in Image Segmentation (BIIS) v0-1")
public class Optimizer_v9_img_fastPipe<T extends RealType<T>> implements Command {
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Inputs
    ...
    Pipeline_fMN pipe = new Pipeline_fMN();
    ...
    final File file = new File("/home/mats/Dokumente/postdoc/conferences/fiji_hackathon_dd2019/project_BayesImaging/sampledata/1h+S7_und_S8_tiff+S7+S7_NaCl+/original1.tif");  //ij.ui().chooseFile(null, "open");
        ...
        // invoke the plugin
        ij.command().run(Optimizer_v9_img_fastPipe.class, true);
    }
