...
public class SegmentationAsLabelAction {
	...
	public <T extends SegmenterListModel<? extends SegmentationItem> & SegmentationModel>
		SegmentationAsLabelAction(Extensible extensible,
		T segmenationModel)
	{
		...
		extensible.addMenuItem( MenuBar.SEGMENTER_MENU,
				"Create Label from Segmentation ...", 300, ignore -> ((Runnable) this::addSegmentationAsLabels)
						.run(), null, "");
		extensible.addMenuItem( SegmentationItem.SEGMENTER_MENU,
				"Create Label from Segmentation ...", 300,
				this::addSegmentationAsLabel, null, null);
	}
