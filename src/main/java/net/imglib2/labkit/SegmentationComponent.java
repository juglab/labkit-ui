...
public class SegmentationComponent implements AutoCloseable {
	...
	private void initActions() {
		...
		final ImageLabelingModel labelingModel =
				segmentationModel.imageLabelingModel();
		...
		new SegmentationAsLabelAction(extensible, selectedSegmenter, labelingModel.labeling());
		new BitmapImportExportAction(extensible, labelingModel);
		new LabelEditAction(extensible, fixedLabels, new ColoredLabelsModel(labelingModel));
