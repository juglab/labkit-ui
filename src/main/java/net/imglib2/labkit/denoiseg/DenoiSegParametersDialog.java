...
public class DenoiSegParametersDialog extends JFrame {
	...
	private JPanel getParamPanel(final DenoiSegParameters params, int[] dims) {
		...
		SpinnerModel batchModel = new SpinnerNumberModel(Math.min(64, params.getBatchSize()), 1, depth,
			1);
		...
		SpinnerModel neighborModel = new SpinnerNumberModel(params.getNeighborhoodRadius(), 1, minHW,
			1);
