...
public class TrainClassifier {
		...
		Extensible extensible, M model)
	{
		...
		extensible.addSegmenterMenuItem("Train Classifier",
			((SegmenterListModel) model)::train, GuiUtils.loadIcon("run.png"));
		extensible.addSegmenterMenuItem("Remove Classifier",
			((SegmenterListModel) model)::remove, GuiUtils.loadIcon("remove.png"));
	}
