...
public final class MappingCursor< T > extends AbstractEuclideanSpace implements Cursor< T >
{
	...
	public MappingCursor( final long offset[], final Cursor< ? > cursor, final RandomAccess< T > source )
	{
	...
	{
		this( mappingCursor.offset, mappingCursor.cursor.copyCursor(), mappingCursor.source.copyRandomAccess() );
	}
