...
//		//fake, replace it
//		list.add("RandomForest", new SegmentationEntry("RandomForest", this));
//		for ( int i = 0; i < labels.size(); i++ ) {
//			list.add( labels.get( i ), new SegmentationLabelEntry( labels.get( i ), colors.get( i ), this ) );
//		}
...
//	// -- Helper methods --
//
//	private class SegmentationEntry extends JPanel {
//
//		SegmentationEntry(final String value, SegmentationPanel parent ) {
//			setOpaque(true);
...
//	}
//
//	private class SegmentationLabelEntry extends JPanel {
//
//		SegmentationLabelEntry(final String value, final ARGBType color, SegmentationPanel parent ) {
//			setOpaque(true);
