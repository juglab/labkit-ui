...
public class SegmenterPanel {
	...
	public SegmenterPanel(
		SegmenterListModel<? extends SegmentationItem> segmentationModel, Function<Supplier<SegmentationItem>, JPopupMenu> menuFactory)
	{
			...
			DefaultExtensible extensible)
	{
		return GuiUtils.createCheckboxGroupedPanel(
					segmentationModel.segmentationVisibility(), "Segmentation",
					new SegmenterPanel(segmentationModel, item -> extensible
							.createPopupMenu(SegmentationItem.SEGMENTER_MENU, item))
							.getComponent());
	}
